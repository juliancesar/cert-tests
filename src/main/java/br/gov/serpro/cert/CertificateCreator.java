...
public final class CertificateCreator {
	...
	// LoggerFactory.getLogger(CertificateCreator.class);
	...
	private static final String SECURE_RANDOM_ALGORITHM = "SHA1PRNG"; // Só tem esse!
	...
	public static KeyPair generateKeyPair(String name, int keySize)
		...
		KeyPair kayPair = generator.generateKeyPair();

		SaveKeyPair(CertitficateHelper.APP_CONF_DIR + File.separator + name, kayPair);
	...
	public static KeyStore createRootCertificate(Authority authority, String keyStoreType)
		...
		KeyPair keyPair = generateKeyPair("root", ROOT_KEYSIZE);
	...
	public static KeyStore createServerCertificate(String commonName,
		...
		KeyPair keyPair = generateKeyPair("server", FAKE_KEYSIZE);
